...
// This is the complete edited questions.json content from the user
...
writeFileSync('public/data/questions.json', completeContent);
console.log('✅ Restored questions.json with your edits');
